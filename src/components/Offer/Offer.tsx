                ...
                <ul className=" ">
                        ...
                        <ol start={1} className="ml-2 list-decimal">
                            <li>
                                <p>
                                    ...
                                    проведення державної реєстрації: 20 лютого
                                    2024 року, №2010350000000505399), іменований
                            ...
                            <li>
                                <p>
                                    Кожна зі Сторін зобов’язується дотримуватися
                                    конфіденційності і не надавати третім особам
                                    інформацію щодо цього Договору, крім тієї,
                                    що є загальнодоступною, технічну та іншу
                                    інформацію, отриману від іншої Сторони в
                                    процесі виконання цього Договору, без
                                    попередньої письмової згоди іншої Сторони,
                                    за виключенням випадків, передбачених цим
                    ...
                    <li>
                        ...
                        <ol start={5} className="ml-2 list-decimal star">
                            <li>
                                <p>
                                    Виконавець за цим Договором зобов’язується
                                    надати Замовнику послуги за обраною ним
                                    формою навчання (навчальні програми,
                                    вебінари, онлайн та офлайн тренінги тощо), а
                                    Замовник зобов’язується оплатити ці послуги
                                    у порядку та на умовах, передбачених
                                    Договором.
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p>
                                    ...
                                    діяти від імені Виконавця.їни «Про захист
                                    персональних даних».
                                </p>
                            </li>
                        </ol>
                        ...
                        <ol start={8} className="ml-2 list-decimal">
                                ...
                                <ul className="ml-7">
                                    <li>
                                        <p className=" indent-[-30px]">
                                            ...
                                            сервісу онлайн-транзакцій Portmone
                                    ...
                                    <li>
                                        <p className=" indent-[-30px]">
                                            ...
                                            розрахунковий рахунок Виконавця,
                                            реквізити якого зазначені в розділі
                                            10 цього Договору. Здійснення
                                            Замовником дій, перелічених в цьому
                                            пункті, вважається акцептом оферти.
                            ...
                            <li>
                                <p>
                                    ...
                                    в розділі 10 цього Договору. Виконавець не
                                    несе відповідальності за порядок
                            ...
                            <li>
                                <p>
                                    Невідвідування Замовником всіх чи частини
                                    занять, передбачених розкладом проведення
                                    занять, який розміщується на Веб-сайті, не є
                                ...
                                <ul className="ml-7">
                                    ...
                                    <li>
                                        <p className=" indent-[-30px]">
                                            ...
                                            строк, встановлений в пункті 16
                                            Договору.
                                        </p>
                                    </li>
                                </ul>
                        ...
                        <ol start={21} className="ml-2 list-decimal">
                                ...
                                <ul className="ml-7 ">
                                    <li>
                                        <p className=" indent-[-30px]">
                                            ...
                                            п.3.2.1. цього Договору, він
                                            вважається укладеним з моменту
                                            оплати послуг Замовником і діє до
                                    ...
                                    <li>
                                        <p className=" indent-[-30px]">
                                            ...
                                            розрахунків на умовах, передбачених
                                            п.3.2.2. цього Договору, він
                                            вважається укладеним після
                                            заповнення Замовником реєстраційної
                                            форми, успішного проходження
                                            особистої співбесіди з метою
                                            визначення мотивації та поточного
                                            рівня знань Замовника та здійснення
                                            ним оплати послуг і діє до повного
                            ...
                            <li>
                                <p>
                                    ...
                                    передбаченому п.4.1.5. цього Договору.
                                </p>
                            </li>
                            <li>
                                <p>
                                    Дострокове розірвання Договору можливе у
                                    випадку, передбаченому п.9.5 цього Договору
