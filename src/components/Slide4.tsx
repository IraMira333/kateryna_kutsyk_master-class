                            ...
                            <ol className="list-decimal">
                                <li>
                                    ...
                                    <ul className="list-inside">
                                        <li className="before:content-['-'] before:mr-2">
                                            Покрокова інструкція по завантаженню
                                            та встановленню програми на ваш
                                            пристрій.
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <p>
                                        Огляд основних функцій та можливостей
                                        VN.
                                    </p>
                                </li>
                            </ol>
                        ...
                        <div className="absolute top-[30px] left-[54%] transform -translate-x-1/2  w-[85%]">
                            ...
                            <ol className="list-decimal">
                                <li>
                                    ...
                                    <ul className="list-inside">
                                        <li className="before:content-['-'] before:mr-2">
                                            Як правильно завантажити відео, фото
                                            та аудіо файли у VN.
                                        </li>
                                        <li className="before:content-['-'] before:mr-2">
                                            Організація медіатеки для зручної
                                ...
                                <li>
                                    <p>
                                        ...
                                        формату та роздільної здатності відео.
                                    </p>
                                </li>
                            </ol>
                        </div>
                            ...
                            <ol className="list-decimal">
                                ...
                                <li>
                                    ...
                                    <ul className="list-inside">
                                        ...
                                        <li className="before:content-['-'] before:mr-2">
                                            Як змінювати бітрейт аудіодоріжок
                                            для оптимального звучання.
                                        </li>
                                        <li className="before:content-['-'] before:mr-2">
                                            Рекомендації щодо налаштувань для
                                            різних типів відео (наприклад,
                                            інтерв&#39;ю, музичні кліпи, влог).
                                        </li>
                                    </ul>
                                </li>
                            </ol>
                                ...
                                <li>
                                    ...
                                    <ul className="list-inside">
                                        <li className="before:content-['-'] before:mr-2">
                                            ...
                                            переходи для створення плавних змін
                                            між сценами.
                                        </li>
                                        <li className="before:content-['-'] before:mr-2">
                                            Персоналізація переходів як
                                            створення унікального стилю вашого
                                            відео.
                                        </li>
                                    </ul>
                                </li>
